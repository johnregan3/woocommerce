			...
			$terms = array_filter(
				...
				function( $term ) use ( $taxonomy ) {
					...
					if ( false === $products ) {
						...
						set_transient( $term_transient_name, $products, self::TRANSIENT_LENGTH );
					}
					...
					$products = array_filter(
						$products,
						function( $product ) use ( $term, $taxonomy ) {
							...
							$available_variation_attribute_slugs = array_map(
								function( $variation ) use ( $taxonomy ) {
				...
				set_transient( $terms_transient_name, $terms, self::TRANSIENT_LENGTH );
		}
